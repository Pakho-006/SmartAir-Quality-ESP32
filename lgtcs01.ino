...
//  wifiManager.resetSettings();
  if (!wifiManager.autoConnect("Ltgcs1-ESP32", "aaaaaaaa")) {
...
//  AsyncWiFiManager wifiManager(&server,&dns);
        ...
        HTTPClient http0;
        http0.begin("https://0nb9zeii09.execute-api.eu-west-1.amazonaws.com/hk/clock");
        int http0Code = http0.GET();
        delay(500);
        String payload0 = http0.getString();
        char json0[400];
        payload0.toCharArray(json0, 500);
        USE_SERIAL.println(payload0);
        StaticJsonDocument<400> doc0;
        deserializeJson(doc0, json0);
        nowhour = doc0["hour"];
        nowminute = doc0["minute"];
...
http1.begin("https://i5f9vv35d7.execute-api.eu-west-1.amazonaws.com/devlop/lgtcdynambodb1-1");
